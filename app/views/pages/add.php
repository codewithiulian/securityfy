    ...
    <div class="card-body">
      <form action="<?php echo URLROOT . '/pages/add'; ?>" method="post">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control <?php echo (!empty($data['descriptionError'])) ? 'is-invalid' : ''; ?>" id="description" name="description" rows="3"><?php echo $data['image']; ?></textarea>
        </div>
        <div class="form-group">
          <label for="image">Select image:</label>
          <input type="file" class="form-control-file <?php echo (!empty($data['imageError'])) ? 'is-invalid' : ''; ?>" id="image" name="image">
        </div>
